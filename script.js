...
function logar() {
  ...
  const pessoa = email === "diretor@senai" && senha === "senai123";

  if (pessoa) {
      window.location.href = "/public/homeP.html";
  } else {
...
function cadastrarSala(sala){
    console.log({sala})
    console.log('Apertou')
    document.getElementById('local').value = sala;
    document.getElementById("janela-conteudo").style.display = "none";
    document.getElementById("fundo").style.display = "none";
}

function abrirJanela() {
      document.getElementById("janela-conteudo").style.display = "block";
...
var produtos = [
  {nome: "Sala 1", imagem: "imagens/sala.jpg" }, 
  {nome: "Pavilhão", imagem: "imagens/IMG_4365.jpg"}, 
  {nome: "Auditório", imagem: "imagens/audit.jpg"}, 
  {nome: "Sala 2", imagem: "imagens/legal.jpg"}, 
  {nome: "Sala 3", imagem: "imagens/legal.jpg"}
];

console.log(produtos[0].imagem)

var escolha = document.querySelector('.escolha');

//Laço de Repetição para aparecer os produtos dentro do Input para escolher o local
produtos.forEach((produto) => {
  ...
  button.type = "button"
  button.onclick = () => cadastrarSala(produto.nome);
